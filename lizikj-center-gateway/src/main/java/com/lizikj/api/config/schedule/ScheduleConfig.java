package com.lizikj.api.config.schedule;
...
@Configuration
@EnableSwagger2
public class ScheduleConfig extends BaseSwaggerConfig{
...
//                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .paths(PathSelectors.ant("/schedule/**"))//过滤的接口
                .build()
                .apiInfo(scheduleApiInfo()).globalOperationParameters(list);


    }

	private ApiInfo scheduleApiInfo() {
        Contact contact = new Contact("周枫恩", "http://www.lizikj.com/", "zfe@lizikj.com");
        ApiInfo apiInfo = new ApiInfo("李子网络科技店铺API接口",//大标题
                "REST风格API",//小标题
                "1.0",//版本
                "http://www.lizikj.com/",
                contact,//作者

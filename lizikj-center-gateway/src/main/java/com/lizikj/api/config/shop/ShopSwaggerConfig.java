...
@Configuration
@EnableSwagger2
public class ShopSwaggerConfig extends BaseSwaggerConfig{
...
//                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .paths(PathSelectors.ant("/shop/**"))//过滤的接口
                .build()
                .apiInfo(shopApiInfo()).globalOperationParameters(list);
...
//                .paths(PathSelectors.regex("/resource/.*"))//过滤的接口
//                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .paths(PathSelectors.ant("/virtual/**"))//过滤的接口
                .build()
                .apiInfo(shopApiInfo()).globalOperationParameters(list);

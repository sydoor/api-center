package com.lizikj.api.config.payment;
...
@Configuration
@EnableSwagger2
public class PaymentSwaggerConfig extends BaseSwaggerConfig {
    @Bean
...
//                .pathMapping("/")//api测试请求地址
                .select()
                .paths(PathSelectors.ant("/payment/**"))//过滤的接口
                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .build()
                .apiInfo(paymentApiInfo()).globalOperationParameters(list);
    ...
    private ApiInfo paymentApiInfo() {
        ...
        ApiInfo apiInfo = new ApiInfo("李子网络科技交易服务API接口",//大标题
                "REST风格API",//小标题
                "1.0",//版本
                "http://www.lizikj.com/",
                contact,//作者

package com.lizikj.api.config.msg;
...
@Configuration
@EnableSwagger2
public class MessageSwaggerConfig extends BaseSwaggerConfig {
    @Bean
...
//                .pathMapping("/")//api测试请求地址
                .select()
                .paths(PathSelectors.ant("/message/**"))//过滤的接口
                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .build()
                .apiInfo(messageApiInfo()).globalOperationParameters(list);
    ...
    private ApiInfo messageApiInfo() {
        ...
        ApiInfo apiInfo = new ApiInfo("李子网络科技消息推送服务API接口",//大标题
                "REST风格API",//小标题
                "1.0",//版本
                "http://www.lizikj.com/",
                contact,//作者

...
@ApiModel(value = "分时段优惠创建对象")
public class TimeDiscountActivityDetailCreateVO {
	...
	public String toString() {
		return "TimeDiscountActivityDetailCreateVO [mode=" + mode + ", startTime=" + startTime + ", endTime=" + endTime
				+ ", discount=" + discount + ", categoryIds=" + categoryIds + ", goodsIds=" + goodsIds + ", weeks="
				+ weeks + "]";
	}
